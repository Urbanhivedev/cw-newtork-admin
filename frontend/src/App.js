        ...
        do a faux login page, so I wouldnt have to start placing sidebar in all my components*/}
         ...
         <Route  path="/register" element={<Registerpage/>} />
          ...
          <Route  path="/properties/built/" exact element={<BuiltPropertylist/>} />
           ...
           <Route  path= "/admin/companylist/:pageNumber" element ={<Companytable/>} />
           <Route  path= "/admin/companylist/" element ={<Companytable/>} />

           <Route  path= "/admin/company/:companyname/:pageNumber" element ={<ViewCompany/>} />
           <Route  path= "/admin/company/:companyname" element ={<ViewCompany/>} />

           <Route  path= "/admin/company/joblisting/:companyname/:jobid" element ={<EditJob/>} />
