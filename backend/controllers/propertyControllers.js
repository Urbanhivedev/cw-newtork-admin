...
const colRef = collection(dbtest , "Company")
//const docRef = doc(dbtest, "Company","collection")
...
const propertylist = propertylistfunction(properties,pageSize,page)
...
/* I have to return resjson AT THE VERY END, TO AVOID SCOPE ISSUES IN MY CONTROLLER, HENCE I AM SENDING IT BELOW  */
   ...
   const viewCompanyVacancies = asyncHandler(async(req,res)=>{
    /*res.header("Access-Control-Allow-Origin","*")*/
    ...
    let vacanciesArray
    let count
    const userId= req.params.company

    const propertylistfunction = (array, pageSize, pageNumber) => {
     ...
     // const propertylist = propertylistfunction(companyVacancies,pageSize,page)
   
 

 console.log("page number is",req.query.pageNumber)
    
   
    const userRef = doc(dbtest,'Company',userId)
  
    getDoc(userRef)
     .then((doc) => {
    company = doc.data()  
   companyVacancies= doc.data().jobs/*vacancies will be a key in an object and its value will be an array */
   count = companyVacancies.length
   
   console.log(companyVacancies)


   vacanciesArray=  propertylistfunction(companyVacancies,pageSize,page)
   console.log(vacanciesArray)


    return  res.json({vacanciesArray,id:doc.id,company,page,pages:Math.ceil(count/pageSize)}) 
     }) 
 ...
 const viewJobOpening = asyncHandler(async(req,res)=>{
  /*res.header("Access-Control-Allow-Origin","*")*/
...
console.log("index number is",req.query.index)
  
 
  const jobRef = doc(dbtest,'Company',userId)
 ...
 specificJob = companyVacancies[req.query.index]


  return  res.json({...specificJob,id:doc.id,companyName,companyLogo}) 
   }) 
  ...
  export {getProperties,
    ...
    editProperty,
    addNewProperty,
    useAddressToFindPosition,
    updatePropertyBought,
    updatePropertySold,
    viewCompanyVacancies
    ,viewJobOpening}